...
{
    if((ui->doubleSpinBox_ot->value()*100)!=value)
    {
        ui->doubleSpinBox_ot->setValue((double)((double)value/(double)100));
    }
}

void MainWindow::on_doubleSpinBox_ot_valueChanged(double arg1)
{
    if(((double)ui->horizontalSlider_ot->value()/(double)100)!=arg1)
    {
        ui->horizontalSlider_ot->setValue((int)(arg1*100));
    }
